          ...
          <div className="text-center mb-1">
            ...
            <div className="grid md:grid-cols-4 gap-6 mt-12">
              <div className="bg-white/80 backdrop-blur-xl rounded-2xl p-6 border border-blue-200/50 shadow-xl">
                <div className="text-3xl font-bold text-[#4B73FF] mb-2">
                  5000+
                </div>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 lg:grid-cols-3 gap-6">
            {additionalServices.map((service, index) => (
              <div
                key={index}
                className="group bg-white/80 backdrop-blur-xl rounded-2xl p-6 border border-blue-200/50 shadow-xl hover:shadow-2xl hover:shadow-blue-500/10 transition-all duration-500 transform hover:-translate-y-2 text-center"
              >
          ...
          <div className="grid md:grid-cols-4 gap-8">
            {[
              ...
              },
              {
                step: "02",
                title: "Planning",
                description: "We create a customized solution plan",
                icon: FaCog,
              },
              {
                step: "03",
                title: "Implementation",
                description: "We deliver and implement the solution",
                icon: FaRocket,
              },
              {
                step: "04",
              ...
              <div key={index} className="text-center relative">
                <div className="bg-white/80 backdrop-blur-xl rounded-2xl p-6 border border-blue-200/50 shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2">
                  <div className="text-4xl font-bold text-[#4B73FF] mb-2">
                    {process.step}
                  </div>
